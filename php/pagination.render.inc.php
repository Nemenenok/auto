...
<?php
        ...
        if ($current === 1) {
            $href = '#';
            array_push($classes, 'noactive');
        }
?>
    <li><a href="<?= ($href) ?>" class="<?= implode(' ', $classes) ?>"></a>
<?php
        /**
...
?>
    <li><a data-pagenumber="<?= ($current + $x - $leading) ?>" href="<?= ($href) ?>"><?= ($current + $x - $leading) ?></a>
<?php
            }

            // print current page
?>
    <li><span data-pagenumber="<?= ($current) ?>"><?= ($current) ?></span>
<?php
...
?>
    <li><a data-pagenumber="<?= ($current + $x + 1) ?>" href="<?= ($href) ?>"><?= ($current + $x + 1) ?></a>
<?php
            }
        }
